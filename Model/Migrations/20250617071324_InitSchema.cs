    ...
    public partial class InitSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassMembers", x => new { x.JoinedClassesId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_ClassMembers_Classes_JoinedClassesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Users_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudySections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudySections_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_StudySections_StudySectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WrongOption = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WrongAnswers_StudySections_StudySectionID",
                        column: x => x.StudySectionID,
                        principalTable: "StudySections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassMembers_MembersId",
                table: "ClassMembers",
                column: "MembersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_StudySectionId",
                table: "Questions",
                column: "StudySectionId");

            migrationBuilder.CreateIndex(
                name: "IX_StudySections_LessonId",
                table: "StudySections",
                column: "LessonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WrongAnswers_StudySectionID",
                table: "WrongAnswers",
                column: "StudySectionID");
        }
